...
| Serdes | Fragmented | P2 | `serdes-protocol` interface; **impl by** json/sexp now; later XML/protobuf/Arrow/… — [#132](https://github.com/egao1980/cl-stack/issues/132) · [serdes.md](capabilities/serdes.md) |
