...
| SQL | Fragmented | P2 | three layers: `sql-protocol` (pool/connect) · `sql-query` (SxQL/Core) · `sql-orm` (Mito) — [#101](https://github.com/egao1980/cl-stack/issues/101) · [sql.md](capabilities/sql.md) |
