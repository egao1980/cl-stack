...
**Format tranche (done):** MIME / CBOR / MessagePack / Avro as serdes implementors; `schema-protocol` **0.2.0** `emit-schema` / `parse-schema`; `encoding-protocol` **0.1.2** (RFC 4648 / QP / RLE). Do **not** start compressed gRPC, HTTP/3, or [AI-GAP](AI-GAP.md).
