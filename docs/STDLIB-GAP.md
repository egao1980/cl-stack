...
| Serdes | Fragmented | P2 | **shipped** — `serdes-protocol` **0.2.1** + JSONL/events; `json-protocol` / `sexp-protocol` / `csv-protocol` / `xml-protocol` / `arrow-protocol` implement — [#132](https://github.com/egao1980/cl-stack/issues/132) · [serdes.md](capabilities/serdes.md) |
...
**Still open on this matrix:** none for JSON/CSV/XML. AI leftovers stay in [AI-GAP.md](AI-GAP.md).
