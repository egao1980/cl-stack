...
| Schema | Fragmented | P2 | **shipped** — `schema-protocol` **0.2.0** (`emit-schema` / `parse-schema`) + `schema-protocol-json` **0.1.2** + `schema-protocol-xsd` **0.1.3** + `schema-protocol-arrow` **0.1.1** + `schema-protocol-avro` **0.1.1** — [schema.md](cookbooks/schema.md) |
