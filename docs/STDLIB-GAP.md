...
| Serdes | Fragmented | P2 | **shipped** — `serdes-protocol` **0.2.1** + JSONL/events; json / sexp / csv / xml / arrow / protobuf implement — [#132](https://github.com/egao1980/cl-stack/issues/132) · [serdes.md](capabilities/serdes.md) |
