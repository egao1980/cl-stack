...
| SQL | Fragmented | P2 | three layers: `sql-protocol` · `sql-query` (ANSI Core + dialect backends) · `sql-orm` (Mito) — [#101](https://github.com/egao1980/cl-stack/issues/101) · [sql.md](capabilities/sql.md) |
