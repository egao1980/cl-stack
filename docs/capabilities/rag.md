...
**Status:** `rag-protocol` **0.1.0** + [`rag-backend-memory`](https://github.com/egao1980/rag-backend-memory) **0.1.0** + [`rag-backend-text`](https://github.com/egao1980/rag-backend-text) **0.1.0** · cookbook [rag.md](../cookbooks/rag.md)
...
| LangChain4j / Spring `VectorStore` | `upsert` / `delete-ids` / `query-store` | pgvector / Pinecone / hosted stores |
