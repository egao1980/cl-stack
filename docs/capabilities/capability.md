...
**Status:** wave-1 **done** (`capability-protocol` **0.1.0**, colocated in [`blackboard-protocol`](https://github.com/egao1980/blackboard-protocol)) · cookbook [blackboard.md](../cookbooks/blackboard.md)
