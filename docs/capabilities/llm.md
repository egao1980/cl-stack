...
| **MCP** | **Not here.** Host `create-message` → `generate` is [`ai-agent-protocol/mcp`](ai-agent.md). |
...
| MCP sampling | [`ai-agent-protocol/mcp`](https://github.com/egao1980/ai-agent-protocol) |
