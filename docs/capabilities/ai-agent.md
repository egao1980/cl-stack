...
**Status:** wave-1 (`ai-agent-protocol` **0.2.1** + `/mcp` **0.1.0** · `/ag-ui` **0.2.0** · `/a2a` **0.1.0`) · cookbook [ai-agent.md](../cookbooks/ai-agent.md)
...
| Layer | Repo |
|-------|------|
| Protocol | [`egao1980/ai-agent-protocol`](https://github.com/egao1980/ai-agent-protocol) **0.2.1** |
